...
const ShweayButton = ({ label = 'Contact', className = '', ...buttonProps }: ShweayButtonProps) => {
  return (
    <button className={`relative text-center w-full h-full z-40 ${className}`} {...buttonProps}>
      ...
      <div
        className="absolute bg-linear-to-b from-grad-four to-grad-five"
        style={{
      ...
      <div
        className="absolute bg-grad-five opacity-50"
        style={{
          inset: 'clamp(0.375rem, 1vw, 0.75rem)',
          borderRadius: 'clamp(0.25rem, 0.5vw, 0.5rem)',
        }}
      ...
      {/* Border gradient */}
      <div
        className="absolute border-[2px] border-transparent bg-gradient-to-r from-grad-five/50 to-grad-five bg-clip-border"
        style={{
          inset: 'clamp(0.375rem, 1vw, 0.75rem)',
          borderRadius: 'clamp(0.25rem, 0.5vw, 0.5rem)',
        }}
